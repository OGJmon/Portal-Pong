...
def main():
	...
	geek1 = Striker(posx=20, posy=0, width=10, height=100, speed=10, color=WHITE, screen=screen)
	geek2 = Striker(posx=WIDTH-30, posy=0, width=10, height=100, speed=10, color=GREEN, screen=screen)
